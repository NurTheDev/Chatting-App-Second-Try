...
const Sidebar = () => {
  return (
    <div className="grid grid-cols-12 py-9 px-8 h-screen">
      <div className="col-span-2 bg-primary-purple rounded-[20px] py-10 flex flex-col items-center justify-between">
        ...
        <ul className="flex items-center flex-col gap-y-20">
          {navItems?.map((item) => (
            <li
              key={item.id}
